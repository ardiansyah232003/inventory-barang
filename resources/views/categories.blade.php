    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                @if(Auth::user()->role == 0)
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-category" onclick="addCategory()"><i class="fas fa-plus"></i> Tambah Kategori Baru</button>
                @endif
