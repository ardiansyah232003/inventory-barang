    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-product" onclick="addProduct()"><i class="fas fa-plus"></i> Tambah Produk Baru</button>
                    ...
                    <table id="table" class="table table-sm table-bordered table-hover table-striped">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th>{{ __('Category') }}</th>
                                <th>{{ __('Jumlah') }}</th>
                                <th>{{ __('Harga Penjualan (Rp)') }}</th>
                                <th>{{ __('Harga Diskon (Rp)') }}</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="modal-title" class="modal-title">{{ __('Tambah Produk Baru') }}</h4>
                ...
                <div class="modal-body">
                    <form role="form" id="save" action="{{ route('products.save') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="purchase_price" class="col-sm-4 col-form-label">{{ __('Harga Penjualan') }} (Rp)</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="purchase_price" name="purchase_price">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sale_price" class="col-sm-4 col-form-label">{{ __('Harga Diskon ') }} (Rp)</label>
                            <div class="col-sm-8">
